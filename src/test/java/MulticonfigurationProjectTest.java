...
public class MulticonfigurationProjectTest extends BaseTest {
    ...
    private static final By INPUT_NAME = By.xpath ("//input[@id='name']");
    ...
    public void testMultiConfigurationProjectRenameProjectViaDropDownMenu(){
        ...
        getDriver ().findElement (By.xpath (" //a[@href='job/" + PROJECT_NAME +"/']/button")).click ();
        getDriver ().findElement (By.xpath ("//a[@href='/job/" + PROJECT_NAME + "/confirm-rename']")).click ();
        getDriver ().findElement (By.xpath ("//input[@value='" + PROJECT_NAME + "']")).clear ();
        getDriver ().findElement (By.xpath ("//input[@value='" + PROJECT_NAME + "']")).sendKeys (newName);
        getDriver ().findElement (By.id ("yui-gen1-button")).click ();

        Assert.assertEquals (getDriver ().findElement (By.xpath ("//h1[contains(text(),'Project " + newName + "')]")).getText (),"Project " + newName);
    }
